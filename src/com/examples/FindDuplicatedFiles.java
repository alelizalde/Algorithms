...
public class FindDuplicatedFiles {
	...
	public static void main(String[] args) {
		Path path = FileSystems.getDefault().getPath("/Users/alfonso/Documents/");
		try(BufferedWriter bw = new BufferedWriter(new FileWriter("/Users/alfonso/Documents/dups.txt",true))){

			for(FilePaths file:findDuplicateFiles(path)) {
